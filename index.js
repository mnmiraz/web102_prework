...
const unfundedString = numUnfunded === 1 ? "game remains" : "games remain";
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfunded} ${unfundedString} unfunded. We need your help to fund these amazing games!`;
